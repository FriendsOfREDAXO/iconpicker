...
class rex_yform_value_fa6_iconpicker extends rex_yform_value_text
{
    public function enterObject()
    {
        ...
        if ($this->needsOutput() && $this->isViewable()) {
            ...
            if (!$this->isEditable()) {
                ...
                $this->params['form_output'][$this->getId()] = $this->parse('value.fa6_iconpicker.tpl.php', $templateParams);
            } else {
                $this->params['form_output'][$this->getId()] = $this->parse('value.fa6_iconpicker.tpl.php', $templateParams);
            }
        }
    ...
    {
        return 'fa6_iconpicker|name|label|defaultwert|[no_db]|[attributes]|[notice]|[prepend]';
    }
